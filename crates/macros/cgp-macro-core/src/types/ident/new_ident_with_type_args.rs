...
#[derive(Debug, Clone)]
pub struct NewIdentWithTypeArgs {
    pub ident: Ident,
    pub type_args: TypeArgs,
}

impl Parse for NewIdentWithTypeArgs {
...
impl ToTokens for NewIdentWithTypeArgs {
...
impl From<Ident> for NewIdentWithTypeArgs {
...
impl ToType for NewIdentWithTypeArgs {
    fn to_type(&self) -> Type {
        parse_quote!(#self)
    }
}

impl From<NewIdentWithTypeArgs> for Type {
