...
#[derive(Debug, Clone)]
pub struct NewIdentWithTypeGenerics {
    pub ident: Ident,
    pub type_generics: TypeGenericParams,
}

impl NewIdentWithTypeGenerics {
    pub fn to_type(&self) -> Type {
        parse_quote!(#self)
    }
}

impl From<Ident> for NewIdentWithTypeGenerics {
...
impl Parse for NewIdentWithTypeGenerics {
...
impl ToTokens for NewIdentWithTypeGenerics {
