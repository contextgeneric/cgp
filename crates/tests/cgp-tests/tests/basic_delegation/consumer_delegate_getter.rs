//! A context can satisfy some components by wiring and others by a direct impl,
//! mixing the two freely.
//!
//! Here `App` wires `HasName` to `UseField` through `delegate_components!` while
