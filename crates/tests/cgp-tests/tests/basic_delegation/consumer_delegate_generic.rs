//! A generic getter component can be wired for one type argument and hand-impl'd
//! for another on the same context.
//!
//! `HasValue<Value>` is generic; `App` wires `ValueGetterComponent<String>` to a
