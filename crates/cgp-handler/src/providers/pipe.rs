...
#[cgp_provider]
impl<Context, Tag, Input, CurrentHandler, RestHandlers> Handler<Context, Tag, Input>
    for PipeHandlers<Cons<CurrentHandler, RestHandlers>>
where
    Context: HasAsyncErrorType,
    CurrentHandler: Handler<Context, Tag, Input>,
    PipeHandlers<RestHandlers>: Handler<Context, Tag, CurrentHandler::Output>,
    Tag: Send,
    Input: Send,
{
    type Output =
        <PipeHandlers<RestHandlers> as Handler<Context, Tag, CurrentHandler::Output>>::Output;
