...
- [acceptable/cgp_namespace/duplicate_path_key.rs](../../../crates/tests/cgp-compile-fail-tests/tests/acceptable/cgp_namespace/duplicate_path_key.rs) — a duplicate `cgp_namespace!` `@`-path entry, a *single* `E0119` on the namespace-trait impl.
