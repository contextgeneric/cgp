...
For the full internal walkthrough — the builder helpers, the corner-case handling, and the index of tests and expansion snapshots — see the implementation document [implementation/entrypoints/derive_build_field.md](../../implementation/entrypoints/derive_build_field.md).
