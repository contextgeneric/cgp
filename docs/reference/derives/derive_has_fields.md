...
For the full internal walkthrough — the codegen helpers that build the product and sum spines, the corner-case handling, and the index of tests and expansion snapshots — see the implementation document [implementation/entrypoints/derive_has_fields.md](../../implementation/entrypoints/derive_has_fields.md).
