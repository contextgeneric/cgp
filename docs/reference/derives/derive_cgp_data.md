...
For the full internal walkthrough — the shape dispatch, the record and variant codegen it composes, the corner-case handling, and the index of tests and expansion snapshots — see the implementation document [implementation/entrypoints/derive_cgp_data.md](../../implementation/entrypoints/derive_cgp_data.md).
