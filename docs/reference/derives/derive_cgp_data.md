...
- Entry point: `derive_cgp_data` in [crates/macros/cgp-macro-lib/src/cgp_data.rs](../../../crates/macros/cgp-macro-lib/src/cgp_data.rs), which parses the input into `ItemCgpData` and calls `to_items()`.
...
- Runtime traits: [crates/core/cgp-field/src/traits/](../../../crates/core/cgp-field/src/traits/); the `MapType` markers in `crates/core/cgp-field/src/impls/map_type.rs`.
