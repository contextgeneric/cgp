...
The struct is defined in [crates/core/cgp-component/src/providers/use_default.rs](../../../crates/core/cgp-component/src/providers/use_default.rs) and re-exported in [crates/core/cgp-component/src/providers/mod.rs](../../../crates/core/cgp-component/src/providers/mod.rs). It has no macro-generated impls; the empty-body `#[cgp_impl]` pattern that wires components to it is exercised in [crates/tests/cgp-tests/tests/component_tests/cgp_component/default_impl.rs](../../../crates/tests/cgp-tests/tests/component_tests/cgp_component/default_impl.rs).
