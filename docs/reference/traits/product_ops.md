...
- `AppendProduct` is defined in [crates/core/cgp-field/src/traits/append_product.rs](../../../crates/core/cgp-field/src/traits/append_product.rs), `ConcatProduct` in [crates/core/cgp-field/src/traits/concat_product.rs](../../../crates/core/cgp-field/src/traits/concat_product.rs), and `MapFields` in [crates/core/cgp-field/src/traits/map_fields.rs](../../../crates/core/cgp-field/src/traits/map_fields.rs).
- The [`MapType`](map_type.md) markers `MapFields` applies are in [crates/core/cgp-field/src/impls/map_type.rs](../../../crates/core/cgp-field/src/impls/map_type.rs), and the [`Cons`](../types/cons.md)/`Nil`/[`Either`](../types/either.md)/`Void` building blocks are under [crates/core/cgp-field/src/types/](../../../crates/core/cgp-field/src/types/).
