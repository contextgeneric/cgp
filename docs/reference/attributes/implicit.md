...
For how `#[implicit]` arguments are parsed and lowered into `HasField` bounds and `let` bindings, and the index of tests, see the implementation document [implementation/entrypoints/cgp_fn.md](../../implementation/entrypoints/cgp_fn.md).
