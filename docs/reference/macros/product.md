...
For the full internal walkthrough — the parse-and-`eval` pipeline shared by both forms, the right-fold onto `Nil`, and the index of tests — see the implementation document [implementation/entrypoints/product.md](../../implementation/entrypoints/product.md).
