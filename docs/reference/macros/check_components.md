...
For the full internal walkthrough — the pipeline, the AST types behind each grammar form, the corner-case handling, and the index of expansion snapshots — see the implementation document [implementation/entrypoints/check_components.md](../../implementation/entrypoints/check_components.md).
