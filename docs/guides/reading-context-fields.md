...
This is one of the [modern idioms](modern-idioms.md); it is the value-level counterpart to [writing providers](writing-providers.md) in vanilla-looking form.
...
- [Modern idioms](modern-idioms.md) — the overview and the cases where a getter trait is still the right tool.
